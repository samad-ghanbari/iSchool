                ...
                ColumnLayout
                {
                        ...
                        RowLayout
                        {
                            ...
                            Image
                            {
                                ...
                                source:{
                                    ...
                                    {
                                        return classStudentCoursesPage.student.Photo;
                                    }
                                }
                            }
                            Column{
                    ...
                    Item
                    {
                        ...
                        Button
                        {
                            ...
                            onClicked:
                            {
                                studentStatDrawer.step_id = classStudentCoursesPage.registerModel.step_id
                                studentStatDrawer.base_id = classStudentCoursesPage.registerModel.study_base_id
                                studentStatDrawer.period_id = classStudentCoursesPage.registerModel.study_period_id
