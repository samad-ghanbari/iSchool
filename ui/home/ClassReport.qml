                        ...
                        RowLayout{
                            ...
                            Switch{
                                ...
                                onCheckedChanged:  {
                                    ...
                                    if(checked){
                                        classReportPage.semester_number = 1;
                            ...
                            Switch{
                                ...
                                onCheckedChanged:
                                {
                                    ...
                                    if(checked)
                                    {
                                        classReportPage.semester_number = 2;
                                        perMonthTSW.checked = true
                                        classReportPage.evalType = "per_month"
                                    }
                            ...
                            Switch{
                                ...
                                onCheckedChanged: {
                                    ...
                                    if(checked)
                                    {
                                        classReportPage.semester_number = 0;
                    ...
                    GroupBox{
                        ...
                        RowLayout{
                            ...
                            Switch{
                                ...
                                visible: (classReportPage.semester_number > 0)? true : false
                                font.family: "Kalameh"
                                font.pixelSize: 16
